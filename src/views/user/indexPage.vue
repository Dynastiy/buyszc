<template>
  <div>
    ...
    <section class="mt-4 analytics">
      <div
        class="price--options-1 bg-info p-3 shadow-sm rounded-sm price--options"
      >
      ...
      <div
        class="price--options-2 bg-success p-3 shadow-sm rounded-sm price--options"
      >
        <h1 class="text-white" v-if="deposits">
      ...
      <div
        class="price--options-3 bg-danger p-3 shadow-sm rounded-sm price--options"
      >
        <h1 class="text-white" v-if="deposits">
      ...
      <div
        class="price--options-4 bg-warning p-3 shadow-sm rounded-sm price--options"
      >
        <h1 class="text-white" v-if="deposits">
...
export default {
  ...
  computed: {
    totalDeposits() {
      return (
        Number(this.deposits.canceled_deposits.length) +
        Number(this.deposits.completed_deposits.length) +
        Number(this.deposits.pending_deposits.length)
      );
    },
  },
};
